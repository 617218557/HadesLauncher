...
class MainActivity : AppCompatActivity() {
            ...
            if (!file.isDirectory) {
                ...
                item.setOnClickListener {
                    ...
                    filter = root!!.listFiles().filter {
                        it.uri.path!!.endsWith(GAME_PACKAGE)
                    }
                    packageUri = filter[0].uri
                    ...
                    val toFile =
                        fm.fromUri(Uri.parse(packageUri.toString() + "%2Ffiles%2F" + GAME_ACCOUNT_FILE_NAME))
    ...
    val SP_NAME = "hadeslauncher"
    val SP_URI_TREE = "uritree"
